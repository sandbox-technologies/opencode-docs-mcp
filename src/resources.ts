...
import { listCategories, searchByCategory, getPageByPath } from './search.js';

export function registerDocResources(server: McpServer, getIndex: () => DocsIndex | null): void {
